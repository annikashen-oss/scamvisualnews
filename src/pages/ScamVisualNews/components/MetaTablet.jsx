...
export default function MetaTablet() {
  ...
  return (
    <div className="w-full max-w-[1050px] mx-auto">
      {/* 平板外框：加上 relative 與 overflow-hidden，確保內部絕對定位的遮罩不會跑出框外 */}
      <div className="bg-[#111] p-4 rounded-[40px] shadow-[0_20px_60px_rgba(0,0,0,0.8),inset_0_0_10px_rgba(255,255,255,0.1)] border-4 border-[#333] relative overflow-hidden">
        
        {/* 點擊播放遮罩：使用 absolute inset-0 完美強制覆蓋整個平板內部畫面 */}
        {!played && (
          <div className="absolute inset-0 bg-[rgba(15,23,42,0.95)] backdrop-blur-md flex flex-col justify-center items-center z-50 rounded-[28px]">
            <button
              onClick={handlePlay}
        ...
        <div className="bg-gradient-to-br from-[#f0f4ff] to-[#e2e8f0] rounded-[28px] p-6 md:p-10 min-h-[750px] max-h-[88vh] overflow-y-auto relative flex flex-col items-center text-[#1e293b]">
          ...
          <div className="w-full max-w-[1000px] flex flex-col items-center">
            ...
            {/* 连线 */}
            <div className={`${styles.connectLine} ${showLine ? styles.connectLineShow : ''}`}></div>
            ...
            <div className="flex flex-col md:flex-row justify-center gap-8 md:gap-10 mt-8 w-full relative">
              ...
              <div className="w-full md:w-[450px] flex flex-col items-center">
                <svg className={`${showBranches ? 'opacity-100' : 'opacity-0'} transition-opacity duration-600 w-full h-[35px]`} viewBox="0 0 450 35" preserveAspectRatio="none">
                ...
                <div className={`w-full transition-all duration-700 ${showLeftCard ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                  <div
                  ...
                  >
                    {!flipLeft ? (
                      <div>
                        ...
                        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 text-left">
                          ...
                          <div className="flex flex-wrap gap-1.5 mt-1">
                            ...
                            <span className="bg-white border border-slate-200 px-2.5 py-0.5 rounded text-xs text-slate-600">AI偵測模型</span>
                          </div>
                        </div>
                        <div className="mt-3 bg-emerald-50 p-3 rounded-xl border border-emerald-200 text-left">
                          <h4 className="text-emerald-700 font-bold text-sm">阻斷成功</h4>
                          <div className="flex flex-wrap gap-1.5 mt-1">
                      ...
                      <div className="py-6">
                        ...
                        <div className="bg-white p-4 rounded-xl border border-blue-200 text-[#1e40af] text-sm text-left leading-relaxed">
              ...
              <div className="w-full md:w-[450px] flex flex-col items-center">
                ...
                <div className={`w-full transition-all duration-700 ${showRightCard ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                  <div
                  ...
                  >
                    {!flipRight ? (
                      <div>
                        ...
                        <div className="bg-rose-50 p-3 rounded-xl border border-rose-200 text-left">
                          ...
                          <div className="flex flex-wrap gap-2 mt-1">
                            <span className="bg-white border border-rose-200 px-2.5 py-0.5 rounded text-xs text-rose-700">私人群組</span>
                            <span className="bg-white border border-rose-200 px-2.5 py-0.5 rounded text-xs text-rose-700">Messenger</span>
                            <span className="bg-white border border-rose-200 px-2.5 py-0.5 rounded text-xs text-rose-700">WhatsApp</span>
                          </div>
                        </div>
                        <div className="mt-3 bg-amber-50 p-3 rounded-xl border border-amber-200 text-left">
                          <h4 className="text-amber-700 font-bold text-sm">無法介入：個人資料保護</h4>
                      ...
                      <div className="py-6">
                        ...
                        <div className="bg-white p-4 rounded-xl border border-rose-200 text-[#991b1b] text-sm text-left leading-relaxed">
            ...
            {/* 結論 */}
            <div className={`w-full max-w-[950px] mt-10 bg-[rgba(15,23,42,0.92)] backdrop-blur-xl border border-white/20 p-6 md:p-8 rounded-2xl shadow-[0_20px_45px_rgba(0,0,0,0.35)] text-white text-left transition-all duration-800 ${showConclusion ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
              ...
              <div className="mt-4 p-3 bg-white/5 rounded-lg border-l-4 border-[#38bdf8]">
                <p className="text-[#38bdf8] font-bold text-sm text-center">
                  防治詐騙需要：<strong>平台、政府、用戶三方合作</strong>，才能真正降低風險！
                </p>
              </div>
            </div>
          </div>
